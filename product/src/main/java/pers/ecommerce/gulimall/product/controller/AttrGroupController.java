...
import pers.ecommerce.gulimall.product.excel.AttrGroupExcel;
...
public class AttrGroupController {
    ...
    public Result<AttrGroupDTO> get(@PathVariable("attrGroupId") Long attrGroupId) {

        AttrGroupDTO attrGroupDTO = attrGroupService.get(attrGroupId);

        Long catId = attrGroupDTO.getCatId();
        Long[] catIdList = categoryService.getCatIdList(catId);

        attrGroupDTO.setCatIdList(catIdList);

        return new Result<AttrGroupDTO>().ok(attrGroupDTO);
    }
    ...
    public Result<AttrGroupDTO> save(@RequestBody AttrGroupDTO dto) {
    ...
    public Result<AttrGroupDTO> update(@RequestBody AttrGroupDTO dto) {
    ...
    public void export(@ApiIgnore @RequestParam Map<String, Object> params, HttpServletResponse response) throws Exception {
        ...
        List<AttrGroupDTO> attrGroupDTOList = attrGroupService.list(params);

        ExcelUtils.exportExcelToTarget(response, null, attrGroupDTOList, AttrGroupExcel.class);
    }
}